...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, email: $email, name: $name, photoURL: $photoURL, phoneNumber: $phoneNumber, emailVerified: $emailVerified, createdAt: $createdAt, lastSignInAt: $lastSignInAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, email, name, photoURL,
      phoneNumber, emailVerified, createdAt, lastSignInAt);
