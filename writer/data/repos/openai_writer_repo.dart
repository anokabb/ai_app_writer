...
import '../api/openai_writer_api.dart';
import '../models/text_analysis_model.dart';
import 'writer_repo.dart';

class OpenAIWriterRepo implements WriterRepo {
  final String apiKey;
  final OpenAIWriterApi _api;

  OpenAIWriterRepo({required this.apiKey, required OpenAIWriterApi api}) : _api = api;
